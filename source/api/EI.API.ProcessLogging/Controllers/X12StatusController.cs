...
public class X12StatusController(IBaseControllerServices services)
    : BaseReadTranslationControllerWithoutHistory<X12StatusV1, X12Status, X12StatusTranslation, IX12StatusRepository>(services)
{
    [HttpGet]
    [ApiVersion("1.0")]
    [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(IEnumerable<X12StatusV1>))]
    ...
    [HttpGet("{id:guid}")]
    [ApiVersion("1.0")]
    [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(X12StatusV1))]

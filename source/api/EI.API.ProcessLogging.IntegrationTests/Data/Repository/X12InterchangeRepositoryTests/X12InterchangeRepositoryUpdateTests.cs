...
[TestClass]
public class X12InterchangeRepositoryUpdateTests : BaseRepositoryUpdateTests<ProcessLogDbContext, X12InterchangeRepository, X12Interchange>
{
    ...
    protected override X12Interchange BuildModel(string label) =>
        X12InterchangeRepositoryTestHelpers.BuildX12Interchange(_testConfig.FileProcessLog, ProcessLogConstants.X12Status.Invalid, label);
}
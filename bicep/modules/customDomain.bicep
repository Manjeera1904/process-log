...
param azureContainerAppNameFdqn string
...
@description('The name of the managed identity the service runs as')
...
resource fdqnsecret 'Microsoft.KeyVault/vaults/secrets@2024-04-01-preview' = {
  name: '${azureContainerAppNameFdqn}-fdqn'
  properties: {
    contentType: 'string'

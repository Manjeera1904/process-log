...
[TestClass]
public class X12TransactionSetRepositoryUpdateTests : BaseRepositoryUpdateTests<ProcessLogDbContext, X12TransactionSetRepository, X12TransactionSet>
{
    ...
    protected override X12TransactionSet BuildModel(string label) =>
        X12TransactionSetRepositoryTestHelpers.BuildX12TransactionSet(_testConfig.X12FunctionalGroup, ProcessLogConstants.X12Status.Invalid, label);
}